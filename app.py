...
# ==========================================
# 2. GŁÓWNY CSS (PREMIUM GOLD - POWRÓT DO ELEGANCJI)
# ==========================================
st.markdown("""
<style>
    .stApp {
...
p2 = [
    ...
    {"kto": "ONA", "tekst": "Jakie tempo pocałunków On preferuje: powolne czy dzikie?"},
...
p4 = [
    {"kto": "ONA", "tekst": "Jaka jest Jego najskrytsza fantazja, o której wstydził się powiedzieć?"},
    {"kto": "ON", "tekst": "W jakiej pozycji Ona dochodzi najszybciej i najintensywniej?"},
    {"kto": "ONA", "tekst": "Czy On woli, gdy jesteś uległa, czy gdy to Ty dominujesz?"},
    {"kto": "ON", "tekst": "Co w Twoim zachowaniu w łóżku sprawia, że On całkowicie traci panowanie?"}
]

kary_l1 = ["Całuj moją szyję przez minutę.", "Zrób mi zmysłowy masaż dłoni.", "Zdejmij skarpetki."]
kary_l2 = ["Zdejmij jedną rzecz.", "Weź łyk alkoholu i przekaż mi go ustami.", "Usiądź mi na kolanach."]
kary_l3 = ["Zliż kroplę alkoholu z moich obojczyków.", "Zostań tylko w bieliźnie.", "Wymasuj moje pośladki."]
kary_l4 = ["Zaspokajaj mnie ustami przez minutę.", "Rób ze mną co chcesz przez 3 minuty.", "Zdejmij wszystko."]
...
# ==========================================
# 4. SILNIK SYNCHRONIZACJI (GLOBALNY STAN)
# ==========================================
@st.cache_resource
...
if view_type == "selection":
    ...
    if q_idx < len(state["gra"]):
        ...
        if state["status"] == "question":
            ...
            st.markdown(f"<div class='premium-box' style='background:{bg};'><h1 class='gold-text'>{txt}</h1><p style='color: #8c7a96;'>Zasada Wykupnego: Shot i pomijasz karę! 🥃</p></div>", unsafe_allow_html=True)
