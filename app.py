...
<style>
    ...
    /* PRZYCISKI PILOTA */
    div.stButton > button {
        height: 25vh !important; width: 100% !important;
    ...
    div.stButton:nth-last-child(1) > button p, div.stButton:nth-last-child(2) > button p { 
        font-size: 16px !important; color: #8c7a96 !important; text-shadow: none !important;
    }
...
p4 = [{"kto": "ONA", "tekst": "Gdybyśmy mieli nagrać wspólne wideo, od jakiej sceny chciałabym zacząć?"}, {"kto": "ON", "tekst": "W jakiej pozycji Ona dochodzi najszybciej i najbardziej intensywnie?"}, {"kto": "ONA", "tekst": "Gdybym mogła Cię uwiązać i robić z Tobą co zechcę przez 5 minut, co byłoby pierwsze?"}, {"kto": "ON", "tekst": "Co w Twoim zachowaniu sprawia, że Ona całkowicie traci nad sobą panowanie?"}, {"kto": "ONA", "tekst": "Którą część Twojego ciała chciałabym teraz pieścić ustami najdłużej?"}, {"kto": "ON", "tekst": "Jaka jest Jej najostrzejsza fantazja, która jeszcze nie została zrealizowana?"}, {"kto": "ONA", "tekst": "Gdybyśmy mieli dzisiaj dołączyć do zabawy kogoś trzeciego... czy w ogóle bym to rozważyła?"}, {"kto": "ON", "tekst": "Jakie miejsce publiczne kręci Ją najbardziej jako potencjalna scena seksu?"}, {"kto": "ONA", "tekst": "Co jest dla mnie ważniejsze: technika i tempo czy emocjonalne połączenie?"}, {"kto": "ON", "tekst": "Który z moich fetyszy Ją najbardziej kręci, a który zaskoczył?"}, {"kto": "ONA", "tekst": "Jaka jest najbardziej 'brudna' rzecz, jaką kiedykolwiek o Tobie pomyślałam?"}, {"kto": "ON", "tekst": "Gdybyś miał użyć na Niej dzisiaj kostki lodu lub ciepłego wosku – co by wybrała?"}, {"kto": "ONA", "tekst": "Czy kiedykolwiek fantazjowałam o kobiecie?"}, {"kto": "ON", "tekst": "Który z moich kolegów/koleżanek wydaje mi się najbardziej atrakcyjny seksualnie (według Jej wiedzy)?"}, {"kto": "ONA", "tekst": "Wolisz, kiedy patrzę Ci w oczy, gdy dochodzę, czy kiedy mam je zamknięte?"}, {"kto": "ON", "tekst": "Co kręci Ją bardziej: gdy jestem brutalny, czy gdy jestem nad wyraz delikatny?"}, {"kto": "ONA", "tekst": "Jaki rozdzaj ubrania tematycznego chciałabym, żebyś dzisiaj założył?"}, {"kto": "ON", "tekst": "Co Ona myśli o seksie analnym?"}, {"kto": "ONA", "tekst": "Jaka jest moja ulubiona reakcja Twojego ciała na mój dotyk?"}, {"kto": "ON", "tekst": "Co jest moją największą seksualną słabością?"}, {"kto": "ONA", "tekst": "Gdybyśmy mieli spędzić cały tydzień tylko na seksie, jak by to wyglądało?"}, {"kto": "ON", "tekst": "Co Ona sądzi o seksie w samochodzie na parkingu?"}, {"kto": "ONA", "tekst": "Który moment naszego seksu uważam za najbardziej zwierzęcy?"}, {"kto": "ON", "tekst": "Czego Ona najbardziej zazdrości innym parom w kwestiach łóżkowych?"}, {"kto": "ONA", "tekst": "Co sprawia, że czuję się jak bogini seksu?"}]
...
kary_l2 = ["Weź łyk alkoholu i przekaż mi go ustami podczas pocałunku.", "Zdejmij z partnera jedną, wybraną przez Ciebie część garderoby.", "Pocałuj moje wewnętrzne udo, centymetr po centymetrze, coraz wyżej.", "Przygryź delikatnie płatek mojego ucha i powiedz coś niegrzecznego.", "Zdejmij ze mnie jeden element ubrania samymi zębami.", "Usiądź na moich kolanach okrakiem i spędź tak całą kolejną rundę.", "Wymasuj moje stopy, używając do tego odrobiny balsamu lub drinka.", "Pozwól mi zawiązać Ci oczy na najbliższą rundę.", "Pieść moje dłonie językiem przez 30 sekund.", "Zdejmij pasek z moich spodni używając tylko zębów."]
kary_l3 = ["Zliż odrobinę alkoholu z mojego brzucha lub obojczyka.", "Zostań tylko w bieliźnie na resztę tej fazy gry.", "Wymasuj moje pośladki dłońmi, patrząc mi głęboko w oczy przez minutę.", "Pieść moje ucho i szyję językiem, podczas gdy moje ręce są trzymane przez Ciebie.", "Przejedź językiem od mojego pępka aż do wgłębienia między piersiami.", "Zdejmij moją koszulkę lub bluzkę, używając tylko zębów.", "Przejedź kostką lodu wzdłuż mojego kręgosłupa, a potem zliż wodę.", "Będziesz uległy/uległa przez najbliższe 3 minuty. Robię z Twoim ciałem co chcę.", "Włóż dłonie pod moją bieliznę na minutę, ale nic nie rób.", "Zasymuluj odgłosy, jakie wydajesz podczas seksu, patrząc mi w oczy."]
kary_l4 = ["Zaspokajaj mnie ustami przez pełne 60 sekund (użyj stopera!).", "Rób z moim ciałem co tylko chcesz przez najbliższe 3 minuty.", "Zdejmij z siebie absolutnie wszystko. Resztę gry prowadzisz nago.", "Użyj na partnerze wybranego gadżetu lub dłoni w sposób ekstremalny przez 2 minuty.", "Zwiąż moje ręce (np. paskiem) na najbliższe dwie rundy.", "Wykonaj dla mnie namiętny, 2-minutowy taniec (striptease).", "Zliż kroplę alkoholu z moich najbardziej wrażliwych miejsc.", "Rób mi dobrze ustami dopóki nie powiem, że wystarczy.", "Przejedź językiem po całym moim ciele, od stóp do głów.", "Kary się skończyły. Resztę wieczoru spędzamy bez telefonów w sypialni. 😈"]
...
if view_type == "selection":
    ...
    # TV TYLKO WYŚWIETLA - Zero modyfikacji stanu
    ...
    if q_idx < len(state["gra"]):
        ...
        if state["status"] == "question":
            ...
            # EKRAN PRZEJŚCIA NA PILOCIE
            st.markdown(f"<div class='premium-box' style='padding:20px;'><h2 style='color:#d4af37;'>Wynik wysłany na TV</h2></div>", unsafe_allow_html=True)
