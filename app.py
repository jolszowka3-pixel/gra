...
kary_l1 = [
    "Splećcie dłonie i patrzcie sobie głęboko w oczy przez 60 sekund w całkowitej ciszy.",
    "Pocałuj partnera w jego najwrażliwsze, delikatne miejsce na ciele (poza ustami) i trzymaj tam wargi przez 20 sekund.",
    "Wymasuj bardzo powoli i czule kark oraz skronie partnera opuszkami palców.",
    "Usiądź za partnerem i powoli wodź nosem oraz ustami po jego/jej szyi. Bardzo delikatnie.",
    "Szeptem na ucho powiedz partnerowi dokładnie, co najbardziej podnieca Cię w jego/jej wyglądzie.",
    "Przytulcie się tak mocno, by nie było między Wami wolnej przestrzeni. Oddychajcie wspólnie przez 90 sekund.",
    "Rozepnij koszulę/bluzkę partnera tylko o dwa guziki i złóż tam bardzo czuły pocałunek.",
    ...
    "Zawiąż sobie oczy (albo mocno je zamknij) i pozwól partnerowi wodzić palcami po Twojej twarzy i szyi przez 60 sekund.",
    "Delikatnie przejedź paznokciami po całych plecach partnera – od karku do lędźwi, bardzo powoli.",
    "Pocałuj partnera w oba policzki, w nos, a na koniec daj namiętny, głęboki pocałunek bez użycia języka.",
    "Zbliż swoje usta do ust partnera tak, by się niemal stykały. Rozmawiajcie w tej intymnej odległości przez 2 minuty.",
    "Zdejmij skarpetki partnera i wymasuj mu/jej stopy, używając swoich dłoni, z pełnym zaangażowaniem.",
    "Obejmij twarz partnera obiema dłońmi i zmuś go do uśmiechu najsłodszym buziakiem w czoło.",
    "Niech partner wsunie chłodne dłonie pod Twoją koszulkę na plecach. Wytrzymaj to z uśmiechem.",
    "Złóż mokry pocałunek dokładnie w dołku między obojczykami partnera i zostań tam przez chwilę.",
    "Usiądź tak blisko, by Wasze uda się stykały i nie rozdzielajcie ich do końca fazy pierwszego poziomu.",
    "Zatańcz z partnerem do wyimaginowanej, powolnej piosenki, wtulając się w niego/nią na okrągłą minutę.",
    "Pogryź bardzo delikatnie dolną wargę partnera podczas pocałunku, utrzymując kontakt wzrokowy.",
    "Połóż głowę na kolanach partnera i pozwól mu/jej bawić się Twoimi włosami przez 2 minuty.",
    "Daj partnerowi do zjedzenia kawałek jedzenia (lub łyk wina) prosto z Twoich własnych ust.",
    "Zamknij oczy. Partner ma 3 próby, by pocałować Cię w dowolne miejsce na twarzy lub szyi, a Ty musisz zgadnąć gdzie to było.",
    "Oprzyjcie się czołami o siebie, zamknijcie oczy i trzymajcie się za ręce przez całą minutę.",
    "Złap partnera za biodra, przyciągnij lekko do siebie i głęboko wciągnij powietrze, wdychając jego/jej zapach."
]

kary_l2 = [
    "Zdejmij górną część swojej garderoby (koszulka/bluzka). Zostajesz tak ubrany/a do końca rundy.",
    "Zdejmij jeden element ubrania partnera/partnerki, robiąc to tak powoli i zmysłowo, jak tylko potrafisz.",
    "Połóż się. Partner przez minutę ma prawo wodzić dłońmi po Twoim ciele, ale omija strefy intymne. Nie wolno Ci go dotknąć.",
    "Pocałuj wewnętrzną stronę uda partnera – jak najwyżej się odważysz, ale bez zdejmowania bielizny.",
    "Złóż na szyi partnera gorący pocałunek na tyle mocno, by poczuł dreszcz, a potem czule zliż to miejsce.",
    "Wsuń dłoń pod ubranie partnera z tyłu i zmysłowo, powoli ugniataj pośladki przez 60 sekund.",
    "Usiądź okrakiem na kolanach partnera (w ubraniu) i zacznij powoli się ocierać przez minutę, patrząc w oczy.",
    "Nalej kroplę napoju na swoją klatkę piersiową/dekolt i poproś partnera, by to zlizał.",
    "Rozepnij spodnie partnera. Zsuń je do połowy ud. Zostają tak do kolejnej wylosowanej kary.",
    "Złap partnera za dłonie, przyciśnij je do kanapy/łóżka i zdominuj go głębokim, namiętnym pocałunkiem z językiem.",
    "Rozchyl swoje ubranie, chwyć dłoń partnera i przyciśnij ją mocno do swojej nagiej skóry na piersi/klatce na pełną minutę.",
    "Złóż serię gorących pocałunków biegnących od pępka w dół, zatrzymując się dosłownie centymetr nad krawędzią bielizny.",
    "Przesuwaj językiem wokół sutków partnera (przez ubranie lub pod nim) przez okrągłą minutę.",
    "Wsuń palce za pasek spodni partnera i przyciągnij go zdecydowanie w swoją stronę do zmysłowego pocałunku.",
    "Zawiąż oczy partnerowi szalikiem lub krawatem. Niech skupi się tylko na Twoim dotyku przez najbliższe 2 rundy.",
    "Przejedź kostką lodu wzdłuż karku i kręgosłupa partnera, a następnie delikatnie zliż zimną wodę.",
    "Odwróć partnera tyłem, przytul się do jego pleców i całuj kark, wodząc dłońmi po jego brzuchu.",
    "Zrób partnerowi 2-minutowy, elegancki striptiz, powoli pozbywając się jednego elementu ubrania.",
    "Wsuń dłoń we włosy partnera z tyłu głowy, lekko odchyl i pocałuj bardzo namiętnie w odsłoniętą szyję.",
    "Oprzyj nogę na kanapie/krześle i pozwól partnerowi masować swoje udo oburącz aż po pachwinę.",
    "Przyłóż usta do ucha partnera i wyznaj mu szeptem swoją najnowszą, bardzo pikantną fantazję z nim/nią w roli głównej.",
    "Rozchyl ubranie na piersiach/torsie partnera i 'wymyj' ten kawałek skóry własnym, ciepłym językiem.",
    "Weź palec partnera do ust i zmysłowo go ssij przez 30 sekund, nie odrywając od niego wzroku.",
    "Przyciśnij partnera do ściany swoim ciałem, wsuń udo między jego nogi i całuj z ogromną pasją przez minutę.",
    "Rozepnij swój zamek w spodniach/sukience i pozwól partnerowi wsunąć tam jeden palec na obwódkę bielizny. Bez ruchu przez minutę."
]
